...
#define Omega 0.0
#define N 2048 // 1792 //2816 //  2048                // Количество ячеек по x
#define M 2048 // 1536 // 2304 // 1792                // Количество ячеек по y
#define K (N*M)                // Количество ячеек в сетке
//#define x_min 0.0 // -1500.0 // -1200.0 // -2760.0 // -2500.0 // -1300  //-2000                // -1500.0
#define x_max 2.1 // 650.0  // 500.0 //450.0
#define x_min (x_max/(2.0 * N)) // 650.0  // 500.0 //450.0
#define y_max 2.1 // 2250.0 // 1600.0 //1840.0
...
#define ggg (2.0)  //(5.0/3.0)          // Показатель адиабаты
#define ga (2.0)  //(5.0/3.0)          // Показатель адиабаты
...
#define hx -100.4
#define grad_p true
#define Nmin 7              // Каждую какую точку выводим?
...
#define wat_ (306089 + 4)   // Какую ячейку смотрим
#define wat2_ (wat_ + 75)   // Какую ячейку смотрим
#define list1_ (1453 + 56)   // Какую ячейку смотрим
#define list2_ (1453 + 112)   // Какую ячейку смотрим
...
#define Number1  (1 * 28341900)   // Должно делится на 270
...
#define weight 0.2   // Коэффицент для отбрасывания веса
#define alpha_rot 10.0  // Угол вращения (полный сектор), то есть в одну сторону на половину угла и в другую
...
void Change_Velosity(Sensor* s, const double& Ur, const double& Uthe, const double& Uphi, //
    const double& Vr, const double& Vthe, const double& Vphi, double& X, double& Y, double& Z, const double& cp = 1.0);
